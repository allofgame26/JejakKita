...
<body class="bg-light">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav align-items-lg-center">
          ...
          <li class="nav-item">
            <a href="http://127.0.0.1:8000/admin/login" class="btn btn-hero ms-lg-3 px-4 py-1 rounded-3">Login</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="container my-5 py-5">
    ...
    <div class="d-flex flex-column flex-md-row align-items-center bg-white rounded-3 shadow-sm border border-secondary p-4 p-md-5">
        <div class="flex-shrink-0 me-md-5 mb-4 mb-md-0">
            <img src="https://placehold.co/200x200/cccccc/222222?text=Kepala+Sekolah" alt="Foto Kepala Sekolah" class="rounded-circle" style="width: 150px; height: 150px; object-fit: cover;">
        </div>
        <div class="text-md-start text-center">
            <p class="fs-6 text-muted mb-3">Assalamu'alaikum Warahmatullahi Wabarakatuh.</p>
            <p class="fs-6 text-muted">Puji syukur kehadirat Allah SWT, shalawat serta salam semoga tercurah kepada junjungan kita, Nabi Muhammad SAW. Kami mengucapkan selamat datang di website resmi Sekolah Dasar Islam Terpadu Al Asror. Website ini merupakan media informasi dan komunikasi bagi seluruh civitas akademika dan masyarakat.</p>
            <p class="fs-6 text-muted">Semoga website ini dapat memberikan manfaat yang sebesar-besarnya bagi kita semua. Wassalamu'alaikum Warahmatullahi Wabarakatuh.</p>
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-md-4">
        <article class="card-tentang visi shadow-sm">
          ...
          <p class="fs-6 text-muted">Menjadi sekolah dasar yang unggul dalam prestasi, berkarakter, dan berwawasan lingkungan.</p>
        </article>
      </div>
      <div class="col-md-4">
        <article class="card-tentang misi shadow-sm">
          <div class="title">Misi</div>
          <p class="fs-6 text-muted">Menyelenggarakan pendidikan yang berkualitas dan mengembangkan potensi siswa secara optimal.</p>
        </article>
      </div>
      <div class="col-md-4">
        <article class="card-tentang sejarah shadow-sm">
          <div class="title">Sejarah</div>
          <p class="fs-6 text-muted">Didirikan pada tahun 2024, telah melahirkan banyak alumni yang sukses di berbagai bidang.</p>
        </article>
      </div>
    </div>
  </section>
        ...
        <ul class="splide__list">
          <li class="splide__slide p-2">
            <div class="card card-news shadow-sm">
              <img src="https://placehold.co/400x300/4c4c4c/FFFFFF?text=Berita+1" alt="Berita 1" class="card-img-top" style="height: 12rem; object-fit: cover;">
              <div class="card-body">
                <h5 class="card-title fw-semibold text-dark">Judul Berita Pertama</h5>
                <p class="card-text text-muted">Deskripsi singkat tentang berita ini. Berisi informasi penting yang menarik perhatian pembaca.</p>
              </div>
            </div>
          </li>
          <li class="splide__slide p-2">
            <div class="card card-news shadow-sm">
              <img src="https://placehold.co/400x300/4c4c4c/FFFFFF?text=Berita+2" alt="Berita 2" class="card-img-top" style="height: 12rem; object-fit: cover;">
              <div class="card-body">
                <h5 class="card-title fw-semibold text-dark">Judul Berita Kedua</h5>
                <p class="card-text text-muted">Teks yang lebih panjang untuk berita ini, menjelaskan detail lebih lanjut tentang acara atau kegiatan sekolah.</p>
              </div>
            </div>
          </li>
          <li class="splide__slide p-2">
            <div class="card card-news shadow-sm">
              <img src="https://placehold.co/400x300/4c4c4c/FFFFFF?text=Berita+3" alt="Berita 3" class="card-img-top" style="height: 12rem; object-fit: cover;">
              <div class="card-body">
                <h5 class="card-title fw-semibold text-dark">Judul Berita Ketiga</h5>
                <p class="card-text text-muted">Ini adalah berita tentang pencapaian siswa di kompetisi. Informasi yang inspiratif dan membanggakan.</p>
              </div>
            </div>
          </li>
        </ul>
        ...
        <ul class="splide__list">
          ...
          <li class="splide__slide p-2">
            <div class="card card-pembangunan shadow-sm">
              <img src="https://placehold.co/400x250/dadd59/444444?text=Pembangunan+1" alt="Pembangunan gedung baru" class="card-img-top">
              <div class="card-body">
                <h5 class="card-title">Pembangunan Gedung Baru</h5>
                <p class="card-text">Deskripsi singkat pembangunan gedung baru. Proyek ini bertujuan untuk meningkatkan fasilitas belajar mengajar.</p>
              </div>
            </div>
          </li>
          <!-- Pembangunan Item 2 -->
          <li class="splide__slide p-2">
            <div class="card card-pembangunan shadow-sm">
              <img src="https://placehold.co/400x250/dadd59/444444?text=Pembangunan+2" alt="Pembangunan lapangan" class="card-img-top">
              <div class="card-body">
                <h5 class="card-title">Renovasi Lapangan Olahraga</h5>
                <p class="card-text">Lapangan olahraga yang baru direnovasi untuk menunjang kegiatan ekstrakurikuler siswa.</p>
              </div>
            </div>
          </li>
          <!-- Pembangunan Item 3 -->
          <li class="splide__slide p-2">
            <div class="card card-pembangunan shadow-sm">
              <img src="https://placehold.co/400x250/dadd59/444444?text=Pembangunan+3" alt="Pembangunan kantin" class="card-img-top">
              <div class="card-body">
                <h5 class="card-title">Pembangunan Kantin Sehat</h5>
                <p class="card-text">Kantin baru yang menyediakan makanan sehat dan bergizi bagi seluruh warga sekolah.</p>
              </div>
            </div>
          </li>
        </ul>
  ...
  <section class="container my-5 py-5" id="galeri">
    ...
    <div class="text-center mb-5">
      ...
      <div class="d-flex flex-wrap justify-content-center gap-3 gallery-row">
        <img src="https://placehold.co/200x150/97ab36/ffffff?text=Pembelajaran+1" alt="Kegiatan Pembelajaran 1" class="shadow-sm">
        <img src="https://placehold.co/200x150/97ab36/ffffff?text=Pembelajaran+2" alt="Kegiatan Pembelajaran 2" class="shadow-sm">
        <img src="https://placehold.co/200x150/97ab36/ffffff?text=Pembelajaran+3" alt="Kegiatan Pembelajaran 3" class="shadow-sm">
      </div>
    </div>
    ...
    <div class="text-center mb-5">
      ...
      <div class="d-flex flex-wrap justify-content-center gap-3 gallery-row">
        <img src="https://placehold.co/200x150/dadd59/444444?text=Fasilitas+1" alt="Fasilitas Sekolah 1" class="shadow-sm">
        <img src="https://placehold.co/200x150/dadd59/444444?text=Fasilitas+2" alt="Fasilitas Sekolah 2" class="shadow-sm">
        <img src="https://placehold.co/200x150/dadd59/444444?text=Fasilitas+3" alt="Fasilitas Sekolah 3" class="shadow-sm">
      </div>
    </div>
    ...
    <div class="text-center mb-5">
      ...
      <div class="d-flex flex-wrap justify-content-center gap-3 gallery-row">
        <img src="https://placehold.co/200x150/7363a2/ffffff?text=Ekskul+1" alt="Ekstrakurikuler 1" class="shadow-sm">
        <img src="https://placehold.co/200x150/7363a2/ffffff?text=Ekskul+2" alt="Ekstrakurikuler 2" class="shadow-sm">
        <img src="https://placehold.co/200x150/7363a2/ffffff?text=Ekskul+3" alt="Ekstrakurikuler 3" class="shadow-sm">
      </div>
    </div>
  </section>
  ...
  <section class="kontak-section container my-5 py-5 rounded-4 shadow-lg text-white" id="kontak">
    ...
    <div class="d-flex flex-wrap justify-content-center gap-4">
      <address class="contact-card p-4 rounded-3 shadow-sm w-100" style="max-width: 280px;">
        ...
        <p class="fs-6 fw-semibold text-muted">Jl. Suru Lor, Suruh, Hargomulyo, Kec. Gedangsari, Kabupaten Gunungkidul, Daerah Istimewa Yogyakarta 55863.</p>
      </address>
      ...
      <div class="contact-card p-4 rounded-3 shadow-sm w-100" style="max-width: 280px;">
        ...
        <div class="mt-4 fs-6 fw-semibold text-muted">
          <a href="#" class="d-flex align-items-center gap-2 text-decoration-none text-muted mb-1"><i class="bi bi-instagram"></i> 081*********</a>
          <a href="#" class="d-flex align-items-center gap-2 text-decoration-none text-muted mb-1"><i class="bi bi-instagram"></i> sdit.id</a>
          <a href="#" class="d-flex align-items-center gap-2 text-decoration-none text-muted mb-1"><i class="bi bi-tiktok"></i> sdit.tiktok</a>
          <a href="#" class="d-flex align-items-center gap-2 text-decoration-none text-muted"><i class="bi bi-youtube"></i> sdit.youtube</a>
        </div>
      </div>
    </div>
  </section>
