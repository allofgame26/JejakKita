{{-- filepath: resources/views/filament/resources/data-diri-detail.blade.php --}}
<x-filament::modal width="md">
    <div class="p-6 bg-gradient-to-br from-blue-50 to-white rounded-xl shadow-lg">
        <div class="flex items-center mb-4">
            ...
            <h2 class="text-xl font-bold text-blue-700">Detail Data Diri</h2>
        </div>
        <div class="flex justify-center mb-4">
            @if($record->getFirstMediaUrl('profile'))
                <img src="{{ $record->getFirstMediaUrl('profile') }}" class="w-24 h-24 rounded-full ring-2 ring-blue-400" alt="Foto Profile">
            @else
