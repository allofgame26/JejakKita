...
class m_periodePolicy
{
     ...
     */
    public function view(User $user, m_periode $mPeriode): bool
    {
     ...
     */
    public function update(User $user, m_periode $mPeriode): bool
    {
     ...
     */
    public function delete(User $user, m_periode $mPeriode): bool
    {
     ...
     */
    public function forceDelete(User $user, m_periode $mPeriode): bool
    {
     ...
     */
    public function restore(User $user, m_periode $mPeriode): bool
    {
     ...
     */
    public function replicate(User $user, m_periode $mPeriode): bool
    {
