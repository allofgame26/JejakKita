...
class m_metode_pembayaranPolicy
{
     ...
     */
    public function view(User $user, m_metode_pembayaran $mMetodePembayaran): bool
    {
     ...
     */
    public function update(User $user, m_metode_pembayaran $mMetodePembayaran): bool
    {
     ...
     */
    public function delete(User $user, m_metode_pembayaran $mMetodePembayaran): bool
    {
     ...
     */
    public function forceDelete(User $user, m_metode_pembayaran $mMetodePembayaran): bool
    {
     ...
     */
    public function restore(User $user, m_metode_pembayaran $mMetodePembayaran): bool
    {
     ...
     */
    public function replicate(User $user, m_metode_pembayaran $mMetodePembayaran): bool
    {
