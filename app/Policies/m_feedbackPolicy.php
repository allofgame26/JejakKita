...
class m_feedbackPolicy
{
     ...
     */
    public function view(User $user, m_feedback $mFeedback): bool
    {
     ...
     */
    public function update(User $user, m_feedback $mFeedback): bool
    {
     ...
     */
    public function delete(User $user, m_feedback $mFeedback): bool
    {
     ...
     */
    public function forceDelete(User $user, m_feedback $mFeedback): bool
    {
     ...
     */
    public function restore(User $user, m_feedback $mFeedback): bool
    {
     ...
     */
    public function replicate(User $user, m_feedback $mFeedback): bool
    {
