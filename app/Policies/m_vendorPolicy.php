...
class m_vendorPolicy
{
     ...
     */
    public function view(User $user, m_vendor $mVendor): bool
    {
     ...
     */
    public function update(User $user, m_vendor $mVendor): bool
    {
     ...
     */
    public function delete(User $user, m_vendor $mVendor): bool
    {
     ...
     */
    public function forceDelete(User $user, m_vendor $mVendor): bool
    {
     ...
     */
    public function restore(User $user, m_vendor $mVendor): bool
    {
     ...
     */
    public function replicate(User $user, m_vendor $mVendor): bool
    {
