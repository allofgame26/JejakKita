...
class m_kategori_barangPolicy
{
     ...
     */
    public function view(User $user, m_kategori_barang $mKategoriBarang): bool
    {
     ...
     */
    public function update(User $user, m_kategori_barang $mKategoriBarang): bool
    {
     ...
     */
    public function delete(User $user, m_kategori_barang $mKategoriBarang): bool
    {
     ...
     */
    public function forceDelete(User $user, m_kategori_barang $mKategoriBarang): bool
    {
     ...
     */
    public function restore(User $user, m_kategori_barang $mKategoriBarang): bool
    {
     ...
     */
    public function replicate(User $user, m_kategori_barang $mKategoriBarang): bool
    {
