...
class User extends Authenticatable implements HasMedia, MustVerifyEmail // MustVerifyEmail diimplementasikan jika menggunakan verifikasi email
{
    use HasApiTokens;
    use HasFactory;
    use HasProfilePhoto;
    use Notifiable;
    use TwoFactorAuthenticatable; //untuk 2fa fortify
